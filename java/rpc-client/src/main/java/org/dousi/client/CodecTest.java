...
public class CodecTest {
    ...
    public void testComputeEncodedValueOfParamTypeList1() {
        long encodedCode = Codec.computeEncodedValueOfParamTypeList(new Object[] {1, 2.0, "abc"});
    ...
    public void testComputeEncodedValueOfParamTypeList2() {
        long encodedCode = Codec.computeEncodedValueOfParamTypeList(new Object[] {1, 1});
